...
class SolutionScene(Scene):
    def construct(self):
        ...
        # Triangle - shift down to align with x-axis
        ...
        lbl_a.shift(DOWN * 0.5)
        lbl_b.shift(DOWN * 0.5)
        lbl_c.shift(DOWN * 0.5)
        lbl_r.shift(DOWN * 0.5)
        lbl_s.shift(DOWN * 0.5)
        lbl_k.shift(DOWN * 0.5)
