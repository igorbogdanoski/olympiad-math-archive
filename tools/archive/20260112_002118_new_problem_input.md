...
**Чекор 1: Изразување преку $\cos x$**
...
**Чекор 2: Замена во неравенството**
...
**Чекор 3: Факторизација на полиномот**
...
**Чекор 4: Анализа на квадратниот трином**
...
**Чекор 5: Доказ на неравенството**
Враќаме $t = \cos x$.
