...
class SyntheticGeometry(Scene):
    def construct(self):
        ...
        # C calculation (Intersection of BM and y-axis)
        ...
        # FIX: quadrant expects a vector (UR = Up Right), not an integer (1)
        right_angle = RightAngle(Line(N,M), Line(N,C), length=0.3, quadrant=UR)
