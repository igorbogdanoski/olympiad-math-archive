...
<details>
<summary>Чекор 1: Анализа на аглите околу темето C</summary>
...
<details>
<summary>Чекор 2: Врска помеѓу аглите алфа и бета</summary>
...
<details>
<summary>Чекор 3: Геометриска конструкција и Питагорова теорема</summary>
...
<details>
<summary>Чекор 4: Финализација</summary>
...
class SolutionScene(Scene):
    def construct(self):
        ...
        # Using a simple square-like path
        ang_c = Square(side_length=0.3, color=GRAY).rotate(np.radians(-20)).move_to(C).shift(DOWN*0.2 + LEFT*0.1)

        self.add(circle, tri_abc, line_ad, line_cd, ang_c)
