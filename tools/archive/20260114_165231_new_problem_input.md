...
Значи $a$ може да биде $1, 2, \ldots, 9$ (9 вредности).
...
Најголемото решение е 3. Тоа значи:
- $\frac{b}{8} > 3$ (за да биде 3 вклучено; ако $\frac{b}{8} = 3$, тогаш $x < 3$ не го вклучува 3).
- $\frac{b}{8} \le 4$ (за да биде 4 исклучено).

Значи $b$ може да биде $25, 26, \ldots, 32$ (8 вредности).
