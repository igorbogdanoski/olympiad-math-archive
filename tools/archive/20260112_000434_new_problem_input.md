...
**Чекор 1: Поставување на координатите**

* $A(-3, 0)$
* $B(3, 0)$
* $C(t, 3)$, каде $t \in \mathbb{R}$.

**Чекор 2: Наоѓање на висините**
...
**Чекор 3: Наоѓање на координатите на $H$**
...
**Чекор 4: Елиминација на параметарот $t$**
