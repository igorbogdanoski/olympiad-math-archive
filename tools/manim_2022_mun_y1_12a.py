...
class GeometryScene(Scene):
    def construct(self):
        ...
        text_group = VGroup(
            ...
            MathTex(r"4\pi rr^2 = 64\pi \implies rr^2 = 16 \implies r=4r),
            MathTex(r"H = 8"),
            MathTex(r"P = 2\pi rr^2 + M = 32\pi + 64\pi = 96\pir),
            MathTex(r"V = \pi rr^2 H = 16\pi \cdot 8 = 128\pir),
            MathTex(r"x = \frrac{p}{100} y \implies 96\pi = \frrac{p}{100} 128\pir),
            MathTex(r"p = \frrac{96}{128} \cdot 100 = \frrac{3}{4} \cdot 100 = 75r)
