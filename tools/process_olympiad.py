...
class PlatinumProcessor:
    ...
    def fix_manim_code_logic(self, code):
        ...
        expert_patterns = [
            ...
            # Нови напредни елементи од експертските совети (81-100)
            (r'@widgets\.interact\(',
             '# Совет: @interact автоматски генерира лизгачи за интерактивни параметри во Jupyter.'),
            (r'@widgets\.interact_manual\(',
             '# Совет: @interact_manual додава копче за рачно активирање на тешки симулации.'),
            (r'FloatRangeSlider',
             '# Совет: FloatRangeSlider овозможува избор на интервали за домени на функции.'),
            (r'ToggleButton',
             '# Совет: ToggleButton е корисен за вклучување/исклучување на елементи во сцената.'),
            (r'Text\(',
             '# Совет: Text widget овозможува динамичен внес на ознаки или LaTeX во анимација.'),
            (r'async def construct',
             '# Совет: Во Manim-Web (Pyodide) користи async/await за анимации.'),
            (r'await self\.play|await self\.render_frame',
             '# Совет: Во асинхрони сцени секоја анимација мора да се чека со await.'),
            (r'on_mouse_click',
             '# Совет: on_mouse_click овозможува интерактивно позиционирање на објекти според клик во web/canvas.'),
            (r'getBoundingClientRect',
             '# Совет: getBoundingClientRect се користи за мапирање на координати од browser во Manim.'),
            (r'threading\.Thread',
             '# Совет: threading.Thread овозможува паралелно извршување за реално време/интеракција.'),
            (r'ipywidgets',
             '# Совет: ipywidgets овозможува напредна интеракција и UI во Jupyter/Colab.'),
            (r'VBox|HBox',
             '# Совет: VBox и HBox овозможуваат организација на UI елементи во Jupyter.'),
            (r'Tab\(',
             '# Совет: Tab widget овозможува групирање на контроли во повеќе јазичиња.'),
            (r'background_line_style',
             '# ВНИМАНИЕ: background_line_style не е поддржан во сите верзии на Manim. Отстрани го ако добиете TypeError.'),
            (r'pyglet\.window',
             '# Совет: pyglet.window се користи за напредно ракување со настани од тастатура/глушец.'),
            (r'mouse_point',
             '# Совет: mouse_point овозможува следење на позицијата на глушецот во реално време.'),
            (r'config\.frame_width|config\.frame_height',
             '# Совет: config.frame_width и config.frame_height се користат за мапирање на browser координати во Manim.'),
        ]
