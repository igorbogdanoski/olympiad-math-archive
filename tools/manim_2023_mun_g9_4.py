...
class QuadrilateralArea(Scene):
    def construct(self):
        ...
        text = VGroup(
            ...
            MathTex(r"\text{Area} = \text{Area}(\triangle ABD) + \text{Area}(\triangle BCD)"),
            MathTex(r"\text{Area}(\triangle ABD) = \frac{1}{2}xy"),
            MathTex(r"\text{In } \triangle BCD: BC=CD, \angle C=90^\circ \implies BD^2 = 2BC^2"),
            MathTex(r"\text{In } \triangle ABD: BD^2 = x^2 + y^2"),
            MathTex(r"\implies 2BC^2 = x^2 + y^2 \implies \text{Area}(\triangle BCD) = \frac{BC^2}{2} = \frac{x^2+y^2}{4}"),
            MathTex(r"\text{Total Area} = \frac{xy}{2} + \frac{x^2+y^2}{4} = \frac{2xy + x^2 + y^2}{4}"),
            MathTex(r"= \frac{(x+y)^2}{4} = \frac{10^2}{4} = 25")
