...
![Визуелизација](../../assets/images/2023_mun_g8_1.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2023_mun_g8_1` и генерирајте ја сликата.
...
**Чекор 1: Пресметка на деловите на аголот C**
...
**Чекор 2: Својство на симетрала на страна**
