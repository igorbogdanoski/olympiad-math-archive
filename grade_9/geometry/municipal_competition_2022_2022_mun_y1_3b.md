...
> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_y1_3b` и генерирајте ја сликата.
...
**Чекор 1: Својства на паралелограм $BADC$**
