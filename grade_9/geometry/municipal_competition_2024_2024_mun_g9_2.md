...
![Визуелизација](../../assets/images/2024_mun_g9_2.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2024_mun_g9_2` и генерирајте ја сликата.
...
**Метод: Аналитичка геометрија**
Поставуваме координатен систем со $B$ во $(1,0)$ и $C$ во $(1,1)$. Тогаш $A(0,0), D(0,1)$.
Центарот $O$ е $(0.5, 0.5)$.
Точката $M$ е средина на $AB$, значи $M(0.5, 0)$.

**Чекор 1: Равенки на правите**
...
**Чекор 3: Плоштина на $\triangle MOP$**
