...
![Визуелизација](../../assets/images/2022_mun_g9_14.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g9_14` и генерирајте ја сликата.
...
**Чекор 1: Својство на тангентен четириаголник**
$$ AB + CD = BC + AD = \frac{L}{2} $$

**Чекор 2: Изразување преку k**
