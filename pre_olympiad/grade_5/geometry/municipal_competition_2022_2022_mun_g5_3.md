...
![Визуелизација](../../../assets/images/2022_mun_g5_3.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g5_3` и генерирајте ја сликата.
...
**Чекор 1: Димензии на игралиштето**
Ширина $b = 12$ m.
Должина $a = b + 5 = 12 + 5 = 17$ m.

**Чекор 2: Периметар (еден круг)**
