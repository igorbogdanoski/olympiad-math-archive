...
![Визуелизација](../../../assets/images/2022_mun_g5_4.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g5_4` и генерирајте ја сликата.
...
**Чекор 1: Анализа на хоризонталните страни**
...
**Чекор 2: Анализа на вертикалните страни**
...
**Чекор 3: Пресметка на периметарот**
