...
![Визуелизација](../../assets/images/2022_mun_g9_10.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g9_10` и генерирајте ја сликата.
...
**Чекор 1: Растојание до првата тетива ($c_1 = 24$)**
Половина тетива: $12$.
$$ d_1 = \sqrt{13^2 - 12^2} = \sqrt{169 - 144} = \sqrt{25} = 5 \text{ cm} $$

**Чекор 2: Растојание до втората тетива ($c_2 = 10$)**
Половина тетива: $5$.
$$ d_2 = \sqrt{13^2 - 5^2} = \sqrt{169 - 25} = \sqrt{144} = 12 \text{ cm} $$

**Чекор 3: Вкупно растојание**
