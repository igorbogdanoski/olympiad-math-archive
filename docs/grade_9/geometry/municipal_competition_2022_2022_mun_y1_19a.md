...
![Визуелизација](../../assets/images/2022_mun_y1_19a.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_y1_19a` и генерирајте ја сликата.
...
**Чекор 2: Внатрешен четириаголник**
...
**Чекор 3: Плоштина на кругот**
$$ P_{circle} = R^2\pi = (2\sqrt{2})^2\pi = 8\pi $$

**Чекор 4: Барана плоштина**
