...
![Визуелизација](../../assets/images/2022_mun_y1_15a.png){ width=500 }
## 🧠 Анализа
...
Прво ги претвораме димензиите на големиот блок во сантиметри:
$12 \text{ dm} = 120 \text{ cm}$
$1 \text{ m} = 100 \text{ cm}$
$8 \text{ dm} = 80 \text{ cm}$

Волуменот на големиот блок е:
$$ V_{big} = 120 \cdot 100 \cdot 80 = 960000 \text{ cm}^3 $$

Бидејќи големиот блок е добиен со топење на 1000 мали блокови, волуменот на еден мал блок е:
$$ V_{small} = \frac{V_{big}}{1000} = \frac{960000}{1000} = 960 \text{ cm}^3 $$

Малиот блок има димензии $15 \text{ cm}$, $x$ и $x$ (бидејќи ширината и висината се еднакви).
Неговиот волумен е:
$$ V_{small} = 15 \cdot x \cdot x = 15x^2 $$

Израмнуваме и решаваме за $x$:
$$ 15x^2 = 960 $$
$$ x^2 = \frac{960}{15} = 64 $$
$$ x = \sqrt{64} = 8 \text{ cm} $$

Димензиите на малиот блок се $15 \text{ cm}$, $8 \text{ cm}$ и $8 \text{ cm}$.
Збирот на димензиите е:
$$ 15 + 8 + 8 = 31 \text{ cm} $$
