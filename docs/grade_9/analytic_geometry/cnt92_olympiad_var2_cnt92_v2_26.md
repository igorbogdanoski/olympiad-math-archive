...
## 📐 Скица
<div align="center">
  <img src="../../assets/images/cnt92_v2_26.png" alt="Визуелизација" width="500"/>
</div>
> **👨‍💻 Geo-Mentor Code:**
...
??? tip "Чекор 1: Анализа на $f(x) = -\text{sgn}(x) + \text{sgn}(x+2)$"
    *   $x < -2$: $-(-1) + (-1) = 0$.
    *   $-2 < x < 0$: $-(-1) + 1 = 2$.
    *   $x > 0$: $-(1) + 1 = 0$.
    Графикот има „скалило“ на висина $y=2$ помеѓу $x=-2$ и $x=0$, и е $y=0$ инаку.

??? tip "Чекор 2: Анализа на правата"
...
??? tip "Чекор 3: Геометриски услови"
