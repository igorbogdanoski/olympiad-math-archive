...
![Илустрација за задачата](../../../web/public/assets/images/regional_2025_1_3ab/regional_2025_1_3ab.png)
...
class SolutionScene(Scene):
  def construct(self):
    ...
    # Intersection logic P + t(T-P) = S + u(R-S)
    Q = np.array([5.8, 4.2, 0]) * scale_factor
