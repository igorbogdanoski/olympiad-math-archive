...
## 📝 Текст на задачата
Даден е $\triangle PRQ$ за кој важи $\angle PQR = 120^\circ$. Точката $S$ е пресек на симетралите на аглите $\angle P$ и $\angle R$ (т.е. $\angle QPS = \angle RPS$ и $\angle QRS = \angle PRS$). Колку изнесува аголот $\angle PSR$?

## 📐 Скица


<div align="center">
  <img src="../../assets/images/2022_mun_y2_4a.png" alt="Скица" width="500"/>
</div>
<div align="center">
  <img src="../../assets/images/2022_mun_y2_4a.png" alt="Скица" width="500"/>
</div>
...
??? success "👀 Прикажи го решението"
    ...
    (Или директно со формула: $\angle S = 90 + 120/2 = 150$).
