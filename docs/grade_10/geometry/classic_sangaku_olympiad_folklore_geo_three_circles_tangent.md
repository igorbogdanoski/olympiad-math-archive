...
![Скица](../../assets/images/geo_three_circles_tangent.png)


## 📝 Текст на задачата
Две кружници со радиуси $R$ и $r$ се допираат однадвор и истовремено ја допираат една права $t$. Во просторот помеѓу нив е впишана трета, помала кружница со радиус $x$, која ги допира двете големи кружници и правата. Докажи ја релацијата:
