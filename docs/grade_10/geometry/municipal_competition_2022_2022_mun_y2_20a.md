...
<div align="center">
  <img src="../../assets/images/2022_mun_y2_20a.png" alt="Визуелизација" width="500"/>
</div>
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_y2_20a` и генерирајте ја сликата.

## 🧠 Анализа
**Зошто е оваа задача тешка?**
Ова е истата задача како 20b од Прва година. Користи ја врската $1/a + 1/b = 1/x$ и $a^2+b^2=c^2$.
