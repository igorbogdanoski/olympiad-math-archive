...
![Визуелизација](../../assets/images/2022_mun_y2_18b.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_y2_18b` и генерирајте ја сликата.
...
**Чекор 2: Геометрија на пресекот**
Ромбот е 'навален'. Неговата висина е 15, а висината на квадратот е 17. Значи ромбот е целосно содржан во лентата помеѓу правите $AB$ и $CD$.
Плоштината на пресекот (заедничкиот дел) е трапез со висина 15 и основи $AB=17$ и $MP$.
Проекцијата на страната на ромбот е $x = \sqrt{17^2 - 15^2} = 8$.
Горната основа на пресекот е $17 - 8 = 9$.
