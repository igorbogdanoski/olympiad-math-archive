...
![Визуелизација](../../assets/images/2024_mun_y2_3ab.png){ width=500 }
## 🧠 Анализа
...
## 👩‍🏫 За наставници
Користењето на коефициенти на сличност ($k$) наместо должини на страни го прави доказот многу поелегантен и пократок.