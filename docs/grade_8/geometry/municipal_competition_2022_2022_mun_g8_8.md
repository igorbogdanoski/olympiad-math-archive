...
![Визуелизација](../../assets/images/2022_mun_g8_8.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g8_8` и генерирајте ја сликата.
...
**Чекор 1: Наоѓање на $x$**
Страната на квадратот е 10.
Од долната страна: $7x + 3 = 10$.
$$ 7x = 7 \implies x = 1 $$

**Чекор 2: Плоштина на квадратот**
$$ P_{kv} = 10^2 = 100 $$

**Чекор 3: Плоштини на правоаголниците**
...
**Чекор 4: Вкупна плоштина и процент**
$$ P_{vk} = 6 + 6 + 16 = 28 $$
