...
<div align="center">
  <img src="../../assets/images/2022_mun_g8_2.png" alt="Визуелизација" width="500"/>
</div>
## 🧠 Анализа
...
??? tip "Чекор 1: Страна на квадратот"
    $P_{kv} = a^2 = 16 \implies a = 4$ cm.

??? tip "Чекор 2: Димензии на триаголникот"
    Основата е $b = a = 4$ cm.
    Плоштината е $P_{tr} = 16$ cm² (иста со квадратот).

??? tip "Чекор 3: Пресметка на висината"
