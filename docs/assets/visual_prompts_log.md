...
**📅 Додадено:** 2025-12-23 12:03
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw a right-angled triangle ABC with the right angle at the top vertex C. Draw the altitude CD perpendicular to the hypotenuse AB. Label the segments AD as 4 and BD as 9. Label the altitude CD as h.

### 🆔 Задача: geo_test_01 - Висина кон хипотенузата
**📅 Додадено:** 2025-12-23 12:26
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw a right-angled triangle ABC with the right angle at the top vertex C. Draw the altitude CD perpendicular to the hypotenuse AB. Label the segments AD as 4 and BD as 9. Label the altitude CD as h.

### 🆔 Задача: copernicus_cat2_01 - Рамностран триаголник во квадрат
**📅 Додадено:** 2025-12-23 12:27
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw a square ABCD. Inside the square, draw an equilateral triangle ABE sharing the side AB. Draw segments DE and CE connecting the inner vertex E to the top corners D and C. Mark the angle DEC as the target angle. Highlight that AE=AD and BE=BC to show isosceles triangles.

### 🆔 Задача: geom_8_2018_rect - Плоштина на впишан триаголник во правоаголник
**📅 Додадено:** 2025-12-26 10:19
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw rectangle ABCD with A at bottom-left. Place E on AB such that AE=1/3 AB, F on BC such that BF=2/3 BC, and G as midpoint of AD. Shade triangle EFG.

### 🆔 Задача: geom_8_2015_square - Поделба на дијагонала во квадрат
**📅 Додадено:** 2025-12-26 10:19
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw square ABCD. Draw diagonal AC and diagonal BD intersecting at O. Mark M as midpoint of CD and N as midpoint of BC. Connect AM and AN.

### 🆔 Задача: geom_9_2018_cm - Должина на симетрала преку разлика на страни
**📅 Додадено:** 2025-12-26 10:19
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw triangle ABC with angle A=40 and B=20. Draw bisector CM. Mark point D on AB such that BD=BC.

### 🆔 Задача: geom_8_2018_trap - Агли на основа во специфичен трапез
**📅 Додадено:** 2025-12-26 10:19
**📋 Промпт за Geo-Mentor / AI:**
```text
Draw trapezoid ABCD. Mark midpoints M on AB and N on CD. Draw segment MN. Draw auxiliary lines from N parallel to AD and BC.
