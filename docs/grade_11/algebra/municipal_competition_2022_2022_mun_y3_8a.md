...
??? success "👀 Прикажи го решението"
    ...
    **Случај 2:** $\sin x \le 0$ И $\cos 2x \le 0$.
    ...
    Според понудените одговори во тестот (кои се подмножества), точното множество е она што содржи некој од овие интервали. (На пр. $[0, \pi/6]$ е подмножество на $[0, \pi/4]$).
    
    **Одговор:** Зависи од понудените опции, но аналитичкото решение е унијата на интервалите погоре.
