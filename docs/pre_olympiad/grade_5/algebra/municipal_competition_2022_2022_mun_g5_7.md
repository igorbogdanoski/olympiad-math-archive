...
![Визуелизација](../../../assets/images/2022_mun_g5_7.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g5_7` и генерирајте ја сликата.
...
**Чекор 2: Пресметка на разликата**
$$ \Delta t = 6.5 - 5 = 1.5 \text{ минути} $$

**Чекор 3: Претворање во секунди**
