...
![Визуелизација](../../../assets/images/2023_mun_g5_4.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2023_mun_g5_4` и генерирајте ја сликата.
...
**Чекор 2: Изразување на вториот број**
...
**Чекор 3: Поставување на равенката за збирот**
...
**Чекор 5: Наоѓање на вториот број**
$$ y = 424 - 84 = 340 $$
