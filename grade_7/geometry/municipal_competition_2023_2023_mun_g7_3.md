...
![Визуелизација](../../assets/images/2023_mun_g7_3.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2023_mun_g7_3` и генерирајте ја сликата.
...
**Чекор 2: Наоѓање на останатите агли**
