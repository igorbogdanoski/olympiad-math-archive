...
## 📐 Скица
![Визуелизација](../../assets/images/2025_mun_g7_4.png)

> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2025_mun_g7_4` и генерирајте ја сликата.
...
**Чекор 3: Положбата на $E$ и аголот кај $B$**
