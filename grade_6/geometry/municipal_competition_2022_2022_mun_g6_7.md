...
![Визуелизација](../../assets/images/2022_mun_g6_7.png)


> **👨‍💻 Geo-Mentor Code:**
> Одете во `assets/manim_code_log.md`, копирајте го кодот за `Task_2022_mun_g6_7` и генерирајте ја сликата.
...
## 👩‍🏫 За наставници
Геометриската визуелизација на $(x+a)^2 - x^2$ како L-форма (гномон) е многу покорисна за 6-то одделение отколку алгебарската формула за квадрат на бином.